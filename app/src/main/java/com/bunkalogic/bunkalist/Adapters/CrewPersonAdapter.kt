...
class CrewPersonAdapter(private val ctx: Context, private var mValues: List<Crew>): androidx.recyclerview.widget.RecyclerView.Adapter<CrewPersonAdapter.ViewHolder>() {
