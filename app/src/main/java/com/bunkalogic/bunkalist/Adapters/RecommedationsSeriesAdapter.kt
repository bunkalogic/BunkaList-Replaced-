...
class RecommedationsSeriesAdapter(private val ctx: Context, private var mValues: List<ResultSeries>): androidx.recyclerview.widget.RecyclerView.Adapter<RecommedationsSeriesAdapter.ViewHolder>() {
