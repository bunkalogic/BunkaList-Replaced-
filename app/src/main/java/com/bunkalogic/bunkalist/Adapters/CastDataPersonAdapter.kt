...
class CastDataPersonAdapter(private val ctx: Context, private var mValues: List<CastResult>): androidx.recyclerview.widget.RecyclerView.Adapter<CastDataPersonAdapter.ViewHolder>() {
